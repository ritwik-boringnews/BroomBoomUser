...
const PilotDetails = ({navigation, route}) => {
  ...
  return (
    <BackButtonPage pageName="Pilot Details" navigation={navigation}>
        ...
        <View style={{paddingHorizontal: 20, alignItems: "center"}}>
          ...
          <View
            ...
            <View style={{marginTop: 19, marginBottom: 20}}>
              ...
              <Text style={{marginTop: 5, color: "black"}}>
                {" "}
                {pilotDetails?.pilotDetails?.vehicle_type || "Motorbike"}
              </Text>
              <View
                style={{
                  marginHorizontal: 3,
              ...
              <Text style={{marginTop: 5, color: "black"}}>
                {" "}
                {pilotDetails?.pilotDetails?.vehicle_number || "WB5543"}
              </Text>
              <View
                style={{
                  marginHorizontal: 3,
