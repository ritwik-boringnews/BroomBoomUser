  ...
  return (
    <>
      <View style={styles.container}>
        <Image source={Images.Logo} style={{ width: 54, height: 54, marginTop: metrics.verticalScale(30) }} />
        <View style={{ alignItems: 'center' }}>
          <Image source={Images.Card} style={{ height: 320, width: 320, resizeMode: 'contain', marginTop: 16 }} />
          <View style={{marginVertical: metrics.verticalScale(8), alignItems:'center' }}>
